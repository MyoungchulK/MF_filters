...
=======
                bad_ant[3::4] = True # all D4 antennas, duplication issue
>>>>>>> 50d4aba053771242b26fcef197c6a9a1362536df
    ...
    def get_obviously_bad_run(self):
        ...
        if self.st == 2:
            ...
            bad_run = np.append(bad_run, 10255) # short...
            ...
            bad_run = np.append(bad_run, 546) # short...
            bad_run = np.append(bad_run, 731) # short...
            bad_run = np.append(bad_run, np.arange(800, 801 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 815) # short...
            bad_run = np.append(bad_run, 837) # short...
            bad_run = np.append(bad_run, 850) # short...
            bad_run = np.append(bad_run, 898) # short...
            bad_run = np.append(bad_run, np.arange(934, 935 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 1102) # short...
            bad_run = np.append(bad_run, np.arange(1124, 1144 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(1228, 1229 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 1231) # short...
            bad_run = np.append(bad_run, 1255) # short...
            bad_run = np.append(bad_run, np.arange(1295, 1339 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 1407) # short...
            bad_run = np.append(bad_run, 1502) # short...
            bad_run = np.append(bad_run, 1565) # short...
            bad_run = np.append(bad_run, 1569) # short...
            ...
            bad_run = np.append(bad_run, 1869) # short...
            bad_run = np.append(bad_run, 1872) # short...
            bad_run = np.append(bad_run, np.arange(2036, 2038 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(2042, 2043 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 2079) # unknown signal
            bad_run = np.append(bad_run, 2148) # short...
            bad_run = np.append(bad_run, np.arange(2251, 2274 + 1, dtype = int)) # short...           
            bad_run = np.append(bad_run, np.arange(2375, 2400 + 1, dtype = int)) # short...           
            bad_run = np.append(bad_run, 2687) # short...
            bad_run = np.append(bad_run, 2771) # short...
            bad_run = np.append(bad_run, 2869) # short...
            bad_run = np.append(bad_run, 3101) # short...
            bad_run = np.append(bad_run, 3373) # short...
            bad_run = np.append(bad_run, 3429) # short...
            bad_run = np.append(bad_run, 3461) # short...
            bad_run = np.append(bad_run, 3788) # short...
            ...
            bad_run = np.append(bad_run, 4508) # short...           
            bad_run = np.append(bad_run, 4601) # short...           
            bad_run = np.append(bad_run, 4978) # short...           
            bad_run = np.append(bad_run, np.arange(5014, 5025 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 6129) # short...
            bad_run = np.append(bad_run, 6215) # short...
            bad_run = np.append(bad_run, 6219) # short...
            bad_run = np.append(bad_run, 6228) # short...
            bad_run = np.append(bad_run, 6245) # short...
            bad_run = np.append(bad_run, 6270) # short...
            bad_run = np.append(bad_run, 6367) # short...
            bad_run = np.append(bad_run, 6402) # short...
            bad_run = np.append(bad_run, 6477) # short...
            bad_run = np.append(bad_run, 6509) # short...
            bad_run = np.append(bad_run, 6604) # short...
            bad_run = np.append(bad_run, 6661) # short...
            bad_run = np.append(bad_run, 6714) # short...
            bad_run = np.append(bad_run, 6735) # short...
            bad_run = np.append(bad_run, 6862) # short...
            bad_run = np.append(bad_run, 6948) # short...
            bad_run = np.append(bad_run, 6973) # short...
            bad_run = np.append(bad_run, 6978) # short...
            bad_run = np.append(bad_run, np.arange(7122, 7153 + 1, dtype = int)) # 2016 Cal Pulser Sweep
            bad_run = np.append(bad_run, 7275) # short...
            bad_run = np.append(bad_run, 7284) # short...
            bad_run = np.append(bad_run, 7312) # short...
            bad_run = np.append(bad_run, 7509) # short...
            bad_run = np.append(bad_run, 7561) # short...
            bad_run = np.append(bad_run, 7570) # short...
            bad_run = np.append(bad_run, 7581) # short...
            bad_run = np.append(bad_run, 7623) # short...
            bad_run = np.append(bad_run, 7640) # short...
            bad_run = np.append(bad_run, 7739) # short...
            ...
            bad_run = np.append(bad_run, 10227) # short...
            bad_run = np.append(bad_run, 10232) # short...
            bad_run = np.append(bad_run, 10245) # short...
            bad_run = np.append(bad_run, 10249) # short...
            bad_run = np.append(bad_run, 10260) # short...
            bad_run = np.append(bad_run, np.arange(10319, 10320 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 10327) # short...
            bad_run = np.append(bad_run, 10351) # short...
            bad_run = np.append(bad_run, 10368) # short...
            bad_run = np.append(bad_run, np.arange(10435, 10437 + 1, dtype = int)) # 10436 ~ 10437 2018/03/22 unknown signal
            bad_run = np.append(bad_run, 10440) # short...
            bad_run = np.append(bad_run, np.arange(10449, 10450 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 10522) # short...
            bad_run = np.append(bad_run, np.arange(10539, 10540 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 10608) # short...
            bad_run = np.append(bad_run, 10614) # short...
            bad_run = np.append(bad_run, np.arange(10660, 10666 + 1, dtype = int)) # dda issue
            bad_run = np.append(bad_run, 10684) # short...
            bad_run = np.append(bad_run, 10721) # short...
            bad_run = np.append(bad_run, 10734) # short...
            bad_run = np.append(bad_run, 10753) # short...
            bad_run = np.append(bad_run, 10771) # short...
            bad_run = np.append(bad_run, 10806) # short...
            bad_run = np.append(bad_run, 10871) # short...
            bad_run = np.append(bad_run, 10921) # short...
            bad_run = np.append(bad_run, 10974) # 10974 2018/05/18 unknown signal
            bad_run = np.append(bad_run, 10979) # short...
            bad_run = np.append(bad_run, 11002) # short...
            bad_run = np.append(bad_run, 11014) # short...
            bad_run = np.append(bad_run, np.arange(11108, 11110 + 1, dtype = int)) # 11108 ~ 11110 2018/06/01 ~ 2 unknown signal
            bad_run = np.append(bad_run, 11179) # short...
            bad_run = np.append(bad_run, np.arange(11256, 11257 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(11300, 11305 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 11323) # short...
            ...
            bad_run = np.append(bad_run, 11339) # short...
            bad_run = np.append(bad_run, 11348) # short...
            bad_run = np.append(bad_run, 11352) # short...
            bad_run = np.append(bad_run, 11376) # short...
            bad_run = np.append(bad_run, 11412) # short...
            bad_run = np.append(bad_run, np.arange(11417, 11421 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(11428, 11432 + 1, dtype = int)) # 2018/07/04 ~ 5 unknown signal
            bad_run = np.append(bad_run, 11523) # short...   
            bad_run = np.append(bad_run, 11608) # short...   
            bad_run = np.append(bad_run, 11621) # short...   
            bad_run = np.append(bad_run, 11678) # short...   
            bad_run = np.append(bad_run, 11693) # short...   
            bad_run = np.append(bad_run, 11697) # short...   
            bad_run = np.append(bad_run, 11716) # short...   
            bad_run = np.append(bad_run, 11753) # short...   
            bad_run = np.append(bad_run, 11764) # short...   
            bad_run = np.append(bad_run, 11834) # short...   
            bad_run = np.append(bad_run, 11846) # short...   
            bad_run = np.append(bad_run, 11923) # short...   
            bad_run = np.append(bad_run, 11932) # short...   
            bad_run = np.append(bad_run, 11979) # short...   
            bad_run = np.append(bad_run, 12095) # short...   
            bad_run = np.append(bad_run, 12116) # short...   
            bad_run = np.append(bad_run, 12144) # short...   
            bad_run = np.append(bad_run, 12151) # short...   
            bad_run = np.append(bad_run, 12167) # short...   
            bad_run = np.append(bad_run, 12193) # short...   
            bad_run = np.append(bad_run, 12218) # short...   
            bad_run = np.append(bad_run, 12252) # short...   
            bad_run = np.append(bad_run, 12320) # short...   
            bad_run = np.append(bad_run, 12351) # short...   
            bad_run = np.append(bad_run, 12375) # short...   
            bad_run = np.append(bad_run, 12412) # short...   
            bad_run = np.append(bad_run, 12458) # short...   
            bad_run = np.append(bad_run, 12469) # short...   
            bad_run = np.append(bad_run, 12481) # short...   
            bad_run = np.append(bad_run, 12483) # short...   
            bad_run = np.append(bad_run, 12527) # short...   
            bad_run = np.append(bad_run, np.arange(12549, 12615 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 12621) # short... 
            bad_run = np.append(bad_run, np.arange(12660, 12661 + 1, dtype = int)) # possibly pulser 
            bad_run = np.append(bad_run, 12681) # short...
            bad_run = np.append(bad_run, 12716) # short...
            bad_run = np.append(bad_run, 12734) # 12734 2018/11/16 unknown signal
            bad_run = np.append(bad_run, 12738) # short...
            bad_run = np.append(bad_run, 12747) # short...
            bad_run = np.append(bad_run, 12752) # short...
            bad_run = np.append(bad_run, 12779) # short...
            bad_run = np.append(bad_run, 12820) # short...
            bad_run = np.append(bad_run, 12822) # short...
            bad_run = np.append(bad_run, np.arange(12830, 12831 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(12838, 12839 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(12862, 12878 + 1, dtype = int)) # short...
            ...
            bad_run = np.append(bad_run, 12912) # short...
            bad_run = np.append(bad_run, np.arange(12922, 12925 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(12927, 12929 + 1, dtype = int)) # possibly pulser
            bad_run = np.append(bad_run, 12959) # short...
            bad_run = np.append(bad_run, 12966) # short...
            bad_run = np.append(bad_run, np.arange(12976, 12983 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 13001) # short...
            ...
            bad_run = np.append(bad_run, 13035) # short...
            ...
            bad_run = np.append(bad_run, 13161) # short...
            bad_run = np.append(bad_run, 13168) # short...
            ...
            bad_run = np.append(bad_run, 13244) # short...
            ...
            bad_run = np.append(bad_run, 13278) # short...
            ...
            bad_run = np.append(bad_run, 13346) # short...           
            bad_run = np.append(bad_run, 13356) # 13356 2019/02/01 unknown signal
            bad_run = np.append(bad_run, 13377) # short...
            bad_run = np.append(bad_run, 13386) # short...
            bad_run = np.append(bad_run, 13428) # short...
            ...
            bad_run = np.append(bad_run, 13457) # short...
            bad_run = np.append(bad_run, 13464) # short...
            bad_run = np.append(bad_run, 13482) # 2019/2/15 unknown signal
            bad_run = np.append(bad_run, 13518) # short... 
            bad_run = np.append(bad_run, 13547) # short...      
            bad_run = np.append(bad_run, 13562) # short...       
            bad_run = np.append(bad_run, np.arange(13592, 13597 + 1, dtype = int)) # short... 
            bad_run = np.append(bad_run, 13602) # short...
            bad_run = np.append(bad_run, 13616) # short...
            bad_run = np.append(bad_run, 13628) # short...
            bad_run = np.append(bad_run, np.arange(13636, 13637 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(13666, 13670 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 13681) # short...
            bad_run = np.append(bad_run, 13699) # short...
            bad_run = np.append(bad_run, 13708) # short...
            bad_run = np.append(bad_run, np.arange(13745, 13748 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(13761, 13762 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 13817) # short...
            bad_run = np.append(bad_run, 13861) # short...
            bad_run = np.append(bad_run, 13961) # short...
            bad_run = np.append(bad_run, np.arange(13964, 13969 + 1, dtype = int)) # low power...
            bad_run = np.append(bad_run, 13966) # short...
            bad_run = np.append(bad_run, 14001) # short...
            bad_run = np.append(bad_run, 14024) # short...
            bad_run = np.append(bad_run, 14032) # short...
            bad_run = np.append(bad_run, 14084) # short...
            bad_run = np.append(bad_run, 14101) # short...
            bad_run = np.append(bad_run, 14112) # short...
            bad_run = np.append(bad_run, 14121) # short...
            bad_run = np.append(bad_run, 14148) # short...
            bad_run = np.append(bad_run, np.arange(14179, 14183 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 14224) # short...
            bad_run = np.append(bad_run, 14254) # short...
            bad_run = np.append(bad_run, 14274) # short...
            bad_run = np.append(bad_run, 14363) # short...
            bad_run = np.append(bad_run, np.arange(14418, 14420 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 14470) # short...
            bad_run = np.append(bad_run, 14472) # short...
            bad_run = np.append(bad_run, 14476) # short...
            bad_run = np.append(bad_run, 14486) # short...
            bad_run = np.append(bad_run, 14567) # short...
            bad_run = np.append(bad_run, 14594) # short...
            bad_run = np.append(bad_run, 14629) # short...
            bad_run = np.append(bad_run, 14633) # short...
            bad_run = np.append(bad_run, 14666) # short...
            bad_run = np.append(bad_run, np.arange(14669, 14670 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 14712) # short...
            bad_run = np.append(bad_run, 14730) # short...
            bad_run = np.append(bad_run, 14738) # short...
            bad_run = np.append(bad_run, 14783) # short...
            bad_run = np.append(bad_run, 14809) # short...
            bad_run = np.append(bad_run, 14820) # short...
            bad_run = np.append(bad_run, 14827) # short...
            bad_run = np.append(bad_run, 14991) # short...
            bad_run = np.append(bad_run, np.arange(15010, 15011 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 15052) # short...
            bad_run = np.append(bad_run, 15058) # short...
            bad_run = np.append(bad_run, np.arange(15101, 15103 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 15164) # short...
            bad_run = np.append(bad_run, np.arange(15205, 15206 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 15215) # short...
            bad_run = np.append(bad_run, 15231) # short...
            bad_run = np.append(bad_run, 15267) # short...
            bad_run = np.append(bad_run, 15270) # short...
            bad_run = np.append(bad_run, np.arange(15316, 15321 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(15369, 15395 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(15403, 15430 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(15453, 15479 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 15509) # short...
            bad_run = np.append(bad_run, np.arange(15517, 15528 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 15562) # short...
            bad_run = np.append(bad_run, np.arange(15576, 15605 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(15604, 15642 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 15648) # short...
            bad_run = np.append(bad_run, np.arange(15676, 15705 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(15751, 15808 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, np.arange(15869, 15897 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 15932) # short...            
            bad_run = np.append(bad_run, 15937) # short...            
            bad_run = np.append(bad_run, 15941) # short...            
            bad_run = np.append(bad_run, 16012) # short...            
            bad_run = np.append(bad_run, 16056) # short...            
            bad_run = np.append(bad_run, 16068) # short...            
            bad_run = np.append(bad_run, 16206) # short...            
            bad_run = np.append(bad_run, 16209) # short...            
            bad_run = np.append(bad_run, 16215) # short...            
            bad_run = np.append(bad_run, 16240) # short...            
            bad_run = np.append(bad_run, 16278) # short...            
            bad_run = np.append(bad_run, 16299) # short...            
            bad_run = np.append(bad_run, 16301) # short...            
            bad_run = np.append(bad_run, 16307) # unkown signal        
            bad_run = np.append(bad_run, 16316) # short...        
            bad_run = np.append(bad_run, np.arange(16347, 16349 + 1, dtype = int)) # 16347 ~ 16348 2019/11/27 possible noise mode    
            bad_run = np.append(bad_run, 16358) # short...            
            ...
            bad_run = np.append(bad_run, 16380) # short...            
            bad_run = np.append(bad_run, 16392) # short...            
            bad_run = np.append(bad_run, np.arange(16415, 16419 + 1, dtype = int)) # obvious short run 
            bad_run = np.append(bad_run, 16434) # short...
            ...
            bad_run = np.append(bad_run, 16472) # short...
            bad_run = np.append(bad_run, 16481) # short...
            bad_run = np.append(bad_run, np.arange(16497, 16498 + 1, dtype = int)) # short...
            bad_run = np.append(bad_run, 16509) # short...
            bad_run = np.append(bad_run, 16514) # short...
            bad_run = np.append(bad_run, np.arange(16518, 16520 + 1, dtype = int)) # unkown signal
            bad_run = np.append(bad_run, 16525) # short...
