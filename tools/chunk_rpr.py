...
def rpr_collector(Data, Ped, analyze_blind_dat = False, use_l2 = False, no_tqdm = False):

    print('Collecting rpr starts!')
    ...
    # hit time 
    handler = py_reco_handler(st, run, wf_int.dt, 8, use_rpr_only = True)
    del st, run
    ...
    del num_ants, ara_root, num_evts, daq_qual_cut_sum, wf_int, handler 

    print('RPR collecting is done!')
