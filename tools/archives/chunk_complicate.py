...
def wf_collector_dat(Data, Ped, Station,
    ...
    file, evtTree, rawEvt, num_evts, cal, q, ch_index, pol_type = ara_raw_to_qual(R, Data, Ped, Station, num_Ants, trig_info = trig_info, yrs = Year)
    del Ped
    ...
    evt_num, act_evt_num, unix_time, trig_num, trig_chs, time_stamp, read_win, qual_num_tot, qual_num, hasKeyInFileError = uproot_loader(Data, Station, event_i, event_f, ch_index,
