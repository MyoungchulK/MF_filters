...
def reco_pulser_collector(Data, Ped, arr_type = '', analyze_blind_dat = False, use_l2 = False, no_tqdm = False):

    print('Collecting reco pulser starts!')
    ...
    from tools.ara_py_interferometers_pulser import py_interferometers
    from tools.ara_py_interferometers_pulser import get_products
    ...
    # interferometers
    ara_int = py_interferometers(wf_int.pad_len, wf_int.dt, st, yr, arr_type = arr_type, run = run, get_sub_file = True, verbose = True)
    pairs = ara_int.pairs
    ...
    theta_bin = ara_int.theta
    phi_bin = ara_int.phi
    radius_bin = ara_int.radius
    print(f'!!!!!!!! pulser type {arr_type} !!!!!!!!!')
    ...
    print('Reco pulser collecting is done!')
