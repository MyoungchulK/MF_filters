...
def sensor_collector(Data, Ped, analyze_blind_dat = False):
    ...
    unix_time = ara_sensorHk_uproot.unix_time
    
    bin_width = 100
    try:
        if ara_sensorHk_uproot.station_id == 2:
    ...
    atri_volt_hist, atri_curr_hist, dda_volt_hist, dda_curr_hist, dda_temp_hist, tda_volt_hist, tda_curr_hist, tda_temp_hist = ara_sensorHk_uproot.get_sensor_hist()
    del Data, ara_sensorHk_uproot
