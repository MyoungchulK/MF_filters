...
def reco_ele_lite_s1_collector(Data, Ped, analyze_blind_dat = False, use_l2 = False, no_tqdm = False):

    print('Collecting reco ele lite second half starts!')
    ...
    print('Reco ele lite second half collecting is done!')
