...
def reco_l2_collector(Data, Ped, analyze_blind_dat = False):
    ...
    yr = ara_uproot.year
    run = ara_uproot.run
    ara_root = ara_root_loader(Data, Ped, st, yr, use_l2 = True, run = run, analyze_blind_dat = analyze_blind_dat, irs_block_number = ara_uproot.irs_block_number)
    del ara_uproot
