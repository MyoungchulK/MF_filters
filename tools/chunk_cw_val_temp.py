...
def cw_val_temp_collector(Data, Ped, analyze_blind_dat = False):
    ...
    irs = ara_uproot.irs_block_number
    ...
    #for evt in range(num_evts):
      #if evt> (num_evts - 100):
        # post quality cut
        if evt > 2000 and evt < 2020:
            print(daq_qual_cut_sum[evt]) 
            print(bool(daq_qual_cut_sum[evt]))
            print(irs[evt])
