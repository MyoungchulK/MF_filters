...
class post_qual_cut_loader:
    ...
    def get_cw_params(self):
        ...
        if self.st == 2:
            ...
            cw_arr_04[:,0] = np.array([0.07, 0.09, 0.07, 0.07, 0.09, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 1000], dtype = float)
            cw_arr_04[:,1] = np.array([0.07, 0.11, 0.07, 0.07, 0.09, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.11, 0.07, 0.11, 0.07, 1000], dtype = float)
            cw_arr_04[:,2] = np.array([0.07, 0.11, 0.07, 0.07, 0.09, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 1000], dtype = float)
            cw_arr_04[:,3] = np.array([0.05, 0.07, 0.05, 0.05, 0.07, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 1000], dtype = float)
            cw_arr_04[:,4] = np.array([0.05, 0.07, 0.05, 0.05, 0.07, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 1000], dtype = float)
            cw_arr_04[:,5] = np.array([0.05, 0.05, 0.05, 0.05, 0.07, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 1000], dtype = float)
        ...
        if self.st == 3:
            cw_arr_04 = np.full((num_ants, num_configs), np.nan, dtype = float)
            cw_arr_04[:,0] = np.array([0.09, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.05, 0.09, 0.07, 0.07, 0.07, 0.07, 0.07, 0.09, 0.07], dtype = float)
            cw_arr_04[:,1] = np.array([0.11, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.11, 0.09, 0.11, 0.07, 0.07, 0.07, 0.09, 0.07], dtype = float)
            cw_arr_04[:,2] = np.array([0.09, 0.05, 0.05, 1000, 0.05, 0.05, 0.09, 1000, 0.07, 0.07, 0.11, 1000, 0.05, 0.05, 0.07, 1000], dtype = float)
            cw_arr_04[:,3] = np.array([0.07, 0.05, 0.05, 1000, 0.05, 0.05, 0.09, 1000, 0.05, 0.07, 0.11, 1000, 0.05, 0.05, 0.07, 1000], dtype = float)
            cw_arr_04[:,4] = np.array([0.11, 0.07, 0.07, 1000, 0.07, 0.07, 0.09, 1000, 0.09, 0.09, 0.07, 1000, 0.07, 0.07, 0.09, 1000], dtype = float)
            cw_arr_04[:,5] = np.array([0.05, 0.07, 0.05, 0.13, 0.05, 0.05, 0.15, 0.05, 0.05, 0.07, 0.07, 0.07, 0.05, 0.05, 0.11, 0.07], dtype = float)
            cw_arr_04[:,6] = np.array([1000, 0.07, 0.05, 0.07, 1000, 0.05, 0.13, 0.03, 1000, 0.07, 0.07, 0.07, 1000, 0.05, 0.11, 0.07], dtype = float)
