...
def dead_dupl_v2_collector(Data, Ped, analyze_blind_dat = False):

    print('Collecting Dead Dupl v2 starts!')
    ...
    qua_num_samps = ara_const.SAMPLES_PER_BLOCK // 2
    del ara_const
    ...
    print('Dead dupl v2 collecting is done!')
