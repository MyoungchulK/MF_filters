...
def reco_ele_lite_q4_collector(Data, Ped, analyze_blind_dat = False, use_l2 = False, no_tqdm = False):
    ...
    q_num_evts = num_evts // 4 + half_num_evts1
    sel_evt_idx = (np.arange(num_evts, dtype = int) > q_num_evts).astype(int)
