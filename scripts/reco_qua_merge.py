...
# sort
m_path = os.path.expandvars("$OUTPUT_PATH") + f'/ARA0{Station}/reco_ele_lite_q1{b_name}/'
ml_path = os.path.expandvars("$OUTPUT_PATH") + f'/ARA0{Station}/reco_ele_lite_q2{b_name}/'
r_path = os.path.expandvars("$OUTPUT_PATH") + f'/ARA0{Station}/reco_ele_lite_f1{b_name}/'
...
for r in tqdm(range(num_runs)):
    ...
    m_name = f'{m_path}reco_ele_lite_q1{b_name}_A{Station}_R{runs[r]}.h5'
    ml_name = f'{ml_path}reco_ele_lite_q2{b_name}_A{Station}_R{runs[r]}.h5'
    r_name = f'{r_path}reco_ele_lite_f1{b_name}_A{Station}_R{runs[r]}.h5'
