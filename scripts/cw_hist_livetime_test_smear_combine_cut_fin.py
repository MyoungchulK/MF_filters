...
if Station == 3:
            ...
            cw_rf_025[:,8] = np.array([0.07, 0.13, 0.13, 0.11, 0.11, 0.11, 0.11, 0.11, 0.15, 0.09, 0.09, 0.07, 0.09, 0.13, 0.09, 0.07], dtype = float)
            ...
            cw_rf_0125[:,8] = np.array([0.03, 0.11, 0.09, 0.03, 0.03, 0.05, 0.05, 0.03, 0.03, 0.07, 0.09, 0.03, 0.03, 0.07, 0.07, 0.03], dtype = float)
            ...
            cw_cal_025[:,8] = np.array([0.11, 0.09, 0.11, 0.07, 0.11, 0.11, 0.07, 0.13, 0.15, 0.13, 0.15, 0.17, 0.15, 0.13, 0.15, 0.13], dtype = float)
            ...
            cw_cal_0125[:,8] = np.array([0.03, 0.05, 0.05, 0.03, 0.03, 0.03, 0.03, 0.03, 0.03, 0.05, 0.05, 0.03, 0.03, 0.05, 0.03, 0.03], dtype = float)
            ...
            cw_soft_025[:,8] = np.array([0.23, 0.17, 0.25, 0.15, 0.25, 0.23, 0.17, 0.21, 0.31, 0.23, 0.31, 0.27, 0.29, 0.27, 0.29, 0.23], dtype = float)
            ...
            cw_soft_0125[:,8] = np.array([0.07, 0.07, 0.11, 0.05, 0.05, 0.13, 0.09, 0.05, 0.05, 0.09, 0.09, 0.09, 0.07, 0.19, 0.11, 0.03], dtype = float)
