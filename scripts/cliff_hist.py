...
for r in tqdm(range(len(d_run_tot))):
    ...
    cliff_adc_rf_wo_bias_cut.append(hf['cliff_adc_rf_hist_wo_bias_cut'][:])
...
hf.create_dataset('cliff_adc_rf_wo_bias_cut', data=np.asarray(cliff_adc_rf_wo_bias_cut), compression="gzip", compression_opts=9)
