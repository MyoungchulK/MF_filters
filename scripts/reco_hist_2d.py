...
for r in tqdm(range(len(d_run_tot))):
  ...
  if r >= count_i and r < count_ff:
    ...
    del pol_idx, cp_cut, num_cuts, cal_cut, evt
    ...
    del g_idx, coef, coef_cut, coord, coord_cut, t_list, rf_t, cal_t, soft_t, coord_cut_cal, coef_cut_cal
...
file_name = f'Reco_Map_New_Cal_2d_A{Station}_R{count_i}.h5'
