...
def wf_loader(CPath = curr_path, Data = None, Ped = None, Output = None, Act_Evt = None):
    ...
    # collecting wf
    #wf_all, roll_mean_all, block_all, nsamp_range, wf_range, amp_range, block_range = vol_calib_collector_dat(Data, Ped, Station, Year, evt_entry)
    roll_mean_all, block_all, nsamp_range, amp_range, block_range = vol_calib_collector_dat(Data, Ped, Station, Year, evt_entry)
    ...
    #del evt_entry, add_tree, wf_all, roll_mean_all, block_all, nsamp_range, wf_range, amp_range, block_range
    del evt_entry, add_tree, roll_mean_all, block_all, nsamp_range, amp_range, block_range
