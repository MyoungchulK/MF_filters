...
def samp_map_loader(CPath = curr_path, Data = None, Ped = None, Output = None):
    ...
    # collecting wf
    results = samp_map_collector_dat(Data, Ped, Station, Year)
    for r in results:
...
if __name__ == "__main__":
    ...
    samp_map_loader(CPath = curr_path+'/..', Data = data, Ped = ped, Output = output)
