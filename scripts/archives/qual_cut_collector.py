...
from tools.chunk_qual_cut import qual_cut_collector_dat

def qual_cut_loader(Data = None, Ped = None, Output = None):
    ...
    if not os.path.exists(Output):
        os.makedirs(Output)
    os.chdir(Output)
    h5_file_name = f'Qual_Cut_A{Station}_R{Run}'
    h5_file_name += f'.h5'
...
if __name__ == "__main__":
    ...
    qual_cut_loader(Data = data, Ped = ped, Output = output)
