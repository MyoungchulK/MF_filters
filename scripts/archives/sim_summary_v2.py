...
ele = np.full((d_len, num_evts), np.nan, dtype = float)
...
hf.create_dataset('rad', data=rad, compression="gzip", compression_opts=9)
hf.create_dataset('phi', data=phi, compression="gzip", compression_opts=9)
hf.create_dataset('ele', data=ele, compression="gzip", compression_opts=9)
