...
unix_freq_rf_cut_map_good = np.copy(unix_freq_rf_cut_map)
unix_freq_rf_cut_map_bad = np.copy(unix_freq_rf_cut_map)
...
for r in tqdm(range(len(d_run_tot))):
    ...
    u_f_map = hf['unix_freq_rf_cut_map'][:]
    ...
    u_f_map_good = np.copy(u_f_map)
    u_f_map_good[bad_idx,:,:] = 0
    u_f_map_bad = np.copy(u_f_map)
    u_f_map_bad[good_idx,:,:] = 0
    ...
    unix_freq_rf_cut_map[min_idx,:,:,g_idx] += u_f_map
    unix_freq_rf_cut_map_good[min_idx,:,:,g_idx] += u_f_map_good
    unix_freq_rf_cut_map_bad[min_idx,:,:,g_idx] += u_f_map_bad
...
file_name = f'CW_Log_{d_type}_A{Station}_v2.h5'
...
hf.create_dataset('unix_freq_rf_cut_map_good', data=unix_freq_rf_cut_map_good, compression="gzip", compression_opts=9)
hf.create_dataset('unix_freq_rf_cut_map_bad', data=unix_freq_rf_cut_map_bad, compression="gzip", compression_opts=9)
