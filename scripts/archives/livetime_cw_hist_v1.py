...
for r in tqdm(range(len(d_run_tot))):
    ...
    tot_sec = hf['cw_total_live_time'][:]
    bad_sec = hf['cw_bad_live_time'][:]
    bad_sec_sum = hf['cw_sum_bad_live_time'][:]
...
file_name = f'Livetime_CW_A{Station}.h5'
