...
def cur_cut(Station, g_idx):
    ...
    if Station == 2:
            ...
            cw_rf_04[:,6] = np.array([1000, 0.10, 0.12, 0.12, 1000, 0.14, 0.12, 0.18, 1000, 0.08, 0.08, 0.10, 1000, 0.16, 0.08, 1000], dtype = float)
            ...
            cw_rf_025[:,6] = np.array([1000, 0.16, 0.14, 0.16, 1000, 0.14, 0.14, 0.14, 1000, 0.20, 0.18, 0.30, 1000, 0.20, 0.18, 1000], dtype = float)
            ...
            cw_rf_0125[:,6] = np.array([1000, 0.06, 0.10, 0.08, 1000, 0.06, 0.06, 0.06, 1000, 0.06, 0.06, 0.12, 1000, 0.10, 0.08, 1000], dtype = float)
            ...
            cw_cal_04[:,6] = np.array([1000, 0.08, 0.08, 0.10, 1000, 0.08, 0.08, 0.10, 1000, 0.06, 0.06, 0.08, 1000, 0.08, 0.08, 1000], dtype = float)
            ...
            cw_cal_025[:,6] = np.array([1000, 0.14, 0.14, 0.16, 1000, 0.10, 0.10, 0.14, 1000, 0.18, 0.16, 0.28, 1000, 0.18, 0.18, 1000], dtype = float)
            ...
            cw_cal_0125[:,6] = np.array([1000, 0.02, 0.04, 0.04, 1000, 0.04, 0.04, 0.04, 1000, 0.06, 0.04, 0.10, 1000, 0.06, 0.04, 1000], dtype = float)
            ...
            cw_soft_04[:,6] = np.array([1000, 0.18, 0.18, 0.20, 1000, 0.20, 0.20, 0.22, 1000, 0.14, 0.16, 0.16, 1000, 0.18, 0.16, 1000], dtype = float)
            ...
            cw_soft_025[:,6] = np.array([1000, 0.30, 0.26, 0.30, 1000, 0.26, 0.24, 0.26, 1000, 0.32, 0.32, 0.48, 1000, 0.32, 0.30, 1000], dtype = float)
            ...
            cw_soft_0125[:,6] = np.array([1000, 0.08, 0.10, 0.16, 1000, 0.12, 0.10, 0.10, 1000, 0.12, 0.04, 0.18, 1000, 0.20, 0.10, 1000], dtype = float)
...
smear_arr_com = np.arange(-smear_len, smear_len+1, 1, dtype = int)
...
file_name = f'CW_Table_Test_Smear_Combine_Cut{blined}_v10_A{Station}_T{trig}_C{ant_c}_S{smear_len}_R{count_i}.h5'
