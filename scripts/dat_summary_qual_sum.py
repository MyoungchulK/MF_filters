...
d_path1 = os.path.expandvars("$OUTPUT_PATH") + f'/ARA0{Station}/Hist/Data_Summary_Qual_v10_A{Station}_R*'
...
for r in tqdm(range(len(d_run_tot1))):
    ...
    qual_ep_corr_t1 = hf['qual_ep_corr_t'][:]
    qual_ep_corr_z1 = hf['qual_ep_corr_z'][:]
    qual_ep_ver_t1 = hf['qual_ep_ver_t'][:]
    qual_ep_ver_z1 = hf['qual_ep_ver_z'][:]
    ...
    qual_ep_corr_t = np.concatenate((qual_ep_corr_t, qual_ep_corr_t1), axis = 0)
    qual_ep_corr_z = np.concatenate((qual_ep_corr_z, qual_ep_corr_z1), axis = 0)
    qual_ep_ver_t = np.concatenate((qual_ep_ver_t, qual_ep_ver_t1), axis = 0)
    qual_ep_ver_z = np.concatenate((qual_ep_ver_z, qual_ep_ver_z1), axis = 0)
    ...
    del hf, qual_ep1, qual_ep_corr_t1, qual_ep_corr_z1, qual_ep_ver_t1, qual_ep_ver_z1
...
file_name = f'Data_Summary_Qual_v10_A{Station}.h5'
