...
if Year == 2013:
    data_list, data_run = list_maker(f'/misc/disk19/data/ARA/RealData/{Year}/filtered/burnSample1in10/ARA0{Station}/root/*/event[0-9]*.root', Station, Year)
else:
    data_list, data_run = list_maker(f'/misc/disk19/data/ARA/RealData/{Year}/unblinded/L1/ARA0{Station}/[0-9][0-9][0-9][0-9]/run[0-9][0-9][0-9][0-9][0-9][0-9]/event[0-9][0-9][0-9][0-9][0-9][0-9].root', Station, Year)
ped_list = repeder_list_maker(f'/misc/disk19/users/mkim/OMF_filter/ARA0{Station}/Ped/',data_run)
